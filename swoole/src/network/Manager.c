...
int swManager_start(swFactory *factory)
{
    ...
    if (SwooleG.task_worker_num > 0)
    {
        ...
        for (i = 0; i < SwooleG.task_worker_num; i++)
        {
          ...
          ///////////////////////////////////////////////////////////////////////////////////////
          //≥ı ºªØworker_num∏ˆworkerΩ¯≥Ã£¨µ´ªπ√ª”–fork£¨fork‘⁄œ¬√ÊΩ¯––
    ...
    case 0:
        ...
        {
            //////////////////////////////////////////////////////////////////////////////////////////////////////////
            //¬Ëµƒ£¨÷’”⁄’“µΩ¡À£¨‘⁄fork workerΩ¯≥Ã÷Æ«∞£¨ ◊œ»fork“ª¥Û∂—task_workerΩ¯≥Ã
...
static int swManager_loop_async(swFactory *factory)
{
    ...
    //hashMap Â≠òÂÇ®oid_pid ->new_pidÁöÑÊò†Â∞Ñ
    ...
    while (SwooleG.running > 0)
    {
        ...
        if (pid < 0)
        {
            //pid < 0 ‰ª£Ë°®managerËøõÁ®ãÊî∂Âà∞reload‰ø°Âè∑ÈáèÔºåÂ∞ÜËøõÁ®ãÁªÑÂ§çÂà∂Âà∞reloadËøõÁ®ãÁªÑÔºåforkÊñ∞ÁöÑËøõÁ®ãÁªÑ
            ...
            if (pid > 0)
            {
                ...
                if (SwooleGS->task_workers.map)
                {
                    ...
                    if (exit_worker != NULL)
                    {
                        ...
                        if (exit_worker->deleted == 1)  //‰∏ªÂä®ÂõûÊî∂‰∏çÈáçÂêØ
                        {
...
static int swManager_loop_sync(swFactory *factory)
{
    ...
    if (serv->onManagerStart)
    {
        serv->onManagerStart(serv);  //‘⁄’‚¿Ô÷¥––ManagerStartªÿµ˜
    }
...
static pid_t swManager_spawn_worker(swFactory *factory, int worker_id)
{
    ...
    else if (pid == 0)  //◊”Ω¯≥Ã£¨“≤æÕ «workerΩ¯≥Ã
    {
